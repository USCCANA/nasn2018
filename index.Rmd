...
\begin{figure}
\centering
\includegraphics[width = .85\linewidth]{muriteams.png}
\end{figure}
...
\begin{figure}
\centering
\includegraphics[width=.65\linewidth]{bias-01-fixed-sizes-4.pdf}
\end{figure}
...
\begin{figure}
\centering
\includegraphics[width=.65\linewidth]{power-01-fixed-sizes-4.pdf}
\end{figure}
...
\begin{figure}
\centering
\includegraphics[width=.65\linewidth]{bias-02-various-sizes-3-4.pdf}
\end{figure}
...
\begin{figure}
\centering
\includegraphics[width=.65\linewidth]{power-02-various-sizes-3-4.pdf}
\end{figure}
...
\begin{figure}
\centering
\includegraphics[height=.7\textheight]{similr.png}
\end{figure}
...
*   Finally, this work can be extended to other types of small networks,
    including: families, egonets, etc. And other methods, such as TERGMs.
